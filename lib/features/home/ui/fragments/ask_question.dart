                        ...
                        Obx(() {
                          return DropdownButton<String>(
                              ...
                              items: landingPageGetController.questionCategories
                                  ...
                                  .toList(),
                              onChanged: (value) {
                                landingPageGetController.onSelectedCategoryChanged(value);
                              });
                        }),
                        SizedBox(
                          ...
                          child: TextEntryField(
                            ...
                            controller:
                                landingPageGetController.questionController,
                            maxLength: 15,
                          ),
                        ),
                        SizedBox(
          ...
          Container(
              ...
              child: Row(
                children: [
                  ...
                  Obx(() {
                    return Text(
                        '₹${landingPageGetController.questionCost.value} (1 Question on ${landingPageGetController.selectedQuestionCategory.value})',
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: Get.height * 0.02,
                            fontWeight: FontWeight.w600));

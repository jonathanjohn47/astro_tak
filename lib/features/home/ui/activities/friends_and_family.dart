    ...
    return Scaffold(
      body: Stack(
        children: [
                            ...
                            ListTile(
                              leading: StandardIconButton(
                                ...
                                onPressed: () {
                                  ...
                                  friendsAndFamilyGetController.editingIndex =
                                      -1;
                                                        ...
                                                        AllRelative(
                                                            ...
                                                            middleName: friendsAndFamilyGetController.nameController.text.split(' ').length > 2
                                                                ? friendsAndFamilyGetController
                                                                    ...
                                                                    .split(' ')[1]
                                                                : '',
                                                            lastName: friendsAndFamilyGetController.nameController.text.split(' ').length == 1 ? '' : friendsAndFamilyGetController.nameController.text.split(' ').last,
          ...
          Obx(() {
            return Visibility(
              visible: friendsAndFamilyGetController.showLoader.value,
            ...
            return Visibility(
              ...
              child: Center(
                child: Card(child: Padding(
                  ...
                  child: CircularProgressIndicator(strokeWidth: 5, color: AppColors.primaryColor,),
                )),
              ),
            );
          })
